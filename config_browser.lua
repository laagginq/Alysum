...
function Loader:Create(enabled)
	...
	Configs.AutomaticCanvasSize = Enum.AutomaticSize.Y
	Configs.ScrollingDirection = Enum.ScrollingDirection.Y
	...
	function Window:Button(info)
		...
		LoadButton.BackgroundColor3 = Color3.fromRGB(111, 50, 168)
		...
		LoadButton.MouseButton1Click:Connect(function()
			...
			LoadButton2.BackgroundColor3 = Color3.fromRGB(111, 50, 168)
